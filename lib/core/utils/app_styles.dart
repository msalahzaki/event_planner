...
class AppStyles {
  ...
  static TextStyle bold20blue = GoogleFonts.inter(
      color: AppColor.primaryLight, fontSize: 20, fontWeight: FontWeight.w700);
  static TextStyle bold16blue = GoogleFonts.inter(
      color: AppColor.primaryLight, fontSize: 16, fontWeight: FontWeight.w700);
  static TextStyle bold14blue = GoogleFonts.inter(
      color: AppColor.primaryLight, fontSize: 14, fontWeight: FontWeight.w700);
  static TextStyle normal16blue = GoogleFonts.inter(
      color: AppColor.primaryLight, fontSize: 16, fontWeight: FontWeight.w500);
  ...
  static TextStyle normal20blue = GoogleFonts.inter(
      color: AppColor.primaryLight, fontSize: 20, fontWeight: FontWeight.w500);
